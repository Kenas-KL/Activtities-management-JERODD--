...
SECRET_KEY = 'django-insecure-)1ofen#2k+_(pxo67mf6d!-h)s)6&5_bv(#trvhr&t9f(3)@+k'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["jerodd.onrender.com",'127.0.0.1']
...
AUTH_USER_MODEL = "activite.MemberUser"
